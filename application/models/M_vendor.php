...
class M_vendor extends CI_model
{
	...
	var $table = 'vendor';
  var $column_order = array('id_vendor','code','nama_vendor','alamat1','alamat2','alamat3','kota','negara','phone_no','fax_no','email','credit_terms','activation_date');
  var $column_search = array('id_vendor','code','nama_vendor','alamat1','alamat2','alamat3','kota','negara','phone_no','fax_no','email','credit_terms','activation_date');
