<div class="row">
     <div class="col-md-12">
         ...
         <div class="portlet light bordered">
             ...
             <a class="btn green btn-outline sbold" onclick="tambah_vendor()"><i class="fa fa-plus"></i> Tambah</a>
...
<!-- /.modal -->
<div class="modal fade bs-modal-lg" id="modal_vendor" tabindex="-1" role="dialog" aria-hidden="true">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="nama_vendor" placeholder="">
                      </div>
                      <div class="form-group">
...
<script>
  $(document).ready(function() {
    $('#table').DataTable({
      ...
      "scrollCollapse": true,
			...
			"order": [],
      "ajax":{
				url : "<?php echo site_url('vendor/ajax_list')?>", // json datasource
				type: "POST"
			},
      "columnDefs": [
			{
  ...
  function tambah_vendor() {
  	save_method = 'tambah';
  	$('#form_vendor')[0].reset(); // reset form on modals
  	$('#modal_vendor').modal('show'); // show bootstrap modal
  ...
  function get_vendor(id_vendor){
    ...
    $('#form_vendor')[0].reset();
        $.ajax({
          url: "<?php echo site_url('vendor/get_vendor')?>/" + id_vendor,
          type: "GET",
          dataType: "JSON",
  ...
  function save() {
    var url;
  	...
  	{
      	url = "<?php echo site_url('vendor/tambah_vendor')?>";
  	}
  	else{
    	url = "<?php echo site_url('vendor/update_vendor')?>";
  	}
     ...
     function delete_vendor(id_vendor) {
      	...
      	if(confirm('Are you sure delete this data?'))
      	{
        	// ajax delete data from database
          	$.ajax({
            	url : "<?php echo site_url('vendor/delete_vendor')?>/"+ id_vendor,
            	type: "POST",
            	dataType: "JSON",
            	success: function(data)
            	{
